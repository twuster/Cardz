...
import cardsui.StackAdapter;
import cardsui.SwipeDismissTouchListener;
import cardsui.SwipeDismissTouchListener.OnDismissCallback;
		...
		return new AnimatorListener() {
			...
			public void onAnimationStart(Animator animation) {
				if (index == 0) {
					...
					// clickedCard.setBackgroundResource(cardsui.R.drawable.);

					// newFirstCard.setBackgroundResource(cardsui.R.drawable.card_background);
